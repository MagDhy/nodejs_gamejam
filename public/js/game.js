...
function preload() {
    ...
    this.load.image('otherPlayer', './assets/spaceshooter/PNG/Enemies/enemyBlack5.png');
    this.load.image('star', 'public/assets/spaceshooter/PNG/Power-ups/star_gold.png');
}
